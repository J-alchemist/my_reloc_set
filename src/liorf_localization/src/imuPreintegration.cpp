...
public:
    ...
    TransformFusion()
    {
        ...
        // imu里程计， 预积分模块发布，都是map下的位姿
        subImuOdometry   = nh.subscribe<nav_msgs::Odometry>(odomTopic+"_incremental",   2000, &TransformFusion::imuOdometryHandler,   this, ros::TransportHints().tcpNoDelay());

        // (最新的预测的位姿 = lidarOdomAffine * imuOdomAffineIncre;)
        pubImuOdometry   = nh.advertise<nav_msgs::Odometry>(odomTopic, 2000);       // 最后的定位
        // 定位路径，一样的
...
public:
    ...
    IMUPreintegration()
    {
        ...
        // lidar里程计(加了2d约束)， 后端mapOptmization模块发出， 预积分器2
